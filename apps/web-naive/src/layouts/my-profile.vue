    ...
    <Spin :spinning="loading" tip="loading...">
      <div class="bg-card px-8">
        <Tabs
          ...
          placement="left"
          @update:value="activeChange"
        >
          <TabPane :key="0" :name="0" :tab="$t('abp.user.myProfile')">
            <ProfileForm />
          </TabPane>
          <TabPane :key="1" :name="1" :tab="$t('abp.user.changePassword')">
            <ResetPasswordForm />
          </TabPane>
          <TabPane :key="2" :name="2" :tab="$t('abp.user.twoFactor')">
